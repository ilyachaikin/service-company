-- Seed data for service_company_db
-- Run AFTER the app has started and created tables (AspNetUsers/roles must exist).
-- Usage: docker exec -i service-company-postgres-1 psql -U postgres service_company_db < docker/seed.sql
